...
function InsurerDashboard() {
    ...
    async function triggerPayout(policyId) {
        ...
        try {
            ...
            // 1. Transfer coverage from pool to investor
            ...
            // 2. Mark policy as paid (now insurer has ADMIN_ROLE)
            const txMark = await registry.markPaidOut(policyId);
            await txMark.wait();

            alert(`Payout of ${policy.coverageAmount.toString()} RWFC executed successfully!`);
            hasFetched.current = false;
            ...
            {!isConnected ? (
                ...
                <>
                    <div className="grid md:grid-cols-3 gap-6 mb-8">
                        ...
                        <StatCard title="Coverage Issued" value={totalCoverage + " RWFC"} />
                    </div>
                            ...
                            policies.map((policy) => (
                                <div key={policy.id.toString()} className="border rounded-lg p-5 mb-5">
                                    <div className="space-y-2">
                                        ...
                                        <p><strong>Coverage:</strong> {policy.coverageAmount.toString()} RWFC</p>
                                        <p><strong>Premium:</strong> {policy.premiumAmount.toString()} RWFC</p>
                    ...
                    <div className="mt-8 bg-white p-6 rounded-xl shadow">
                        ...
                        <div className="space-y-2">
                            ...
                            <p><strong>Total Coverage:</strong> {totalCoverage} RWFC</p>
                        </div>
                    </div>
                </>
            )}
